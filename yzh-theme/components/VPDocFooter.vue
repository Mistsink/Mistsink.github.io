...
import { usePageviewCount, WalinePath, WalineServerURL } from '../utils/walien'

onMounted(usePageviewCount)
onUpdated(usePageviewCount)
  ...
  <footer v-if="showFooter" class="VPDocFooter">
    ...
    <div class="prev-next">
      ...
      <div class="pager center">
        <a class="pager-link" :href="normalizeLink(path.substring(0, path.lastIndexOf('/')))+'/'">
